...
import com.lockwood.themoviedb.movies.remote.SearchMoviesService
...
class SearchServiceModule {
    ...
    @Provides
    @FeatureScope
    fun provideMoviesSearchService(@AuthRetrofit retrofit: Retrofit.Builder): SearchMoviesService {
